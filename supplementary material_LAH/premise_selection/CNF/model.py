...
class PremiseSelectionModel(nn.Module):
    def __init__(self, node_in_channels, node_out_channels, layers, logic_rules="r1_r2",
        ...
        rule_cfg = {
            ...
            "all_l":  (False, False, False, True, True, False),
        }
        cr1, cr2, cr3, lr1, lr2, lr3 = rule_cfg.get(logic_rules, (True, True, False, True, True, False))
    ...
    def forward(self, batch):
        ...
        prem_graph = batch.prem_graphs[0] if hasattr(batch, 'prem_graphs') else None
        conj_graph = batch.conj_graphs[0] if hasattr(batch, 'conj_graphs') else None
