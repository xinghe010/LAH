...
class Classifier(nn.Module):
    ...
    def apply_hard_rules(self, conj_graph, prem_graph, pred_y):  
        if prem_graph is None and prem_graph is None:
            return pred_y     
...
class PremiseSelectionModel(nn.Module):
    def __init__(self, node_in_channels, node_out_channels, layers, logic_rules="all"):
        ...
        self.corrects = None
        self.logic_loss_weight = 0.2 
        self.logic_loss = LogicLoss(node_out_channels)

        if logic_rules == "all":
            self.classifier = Classifier(node_out_channels, use_r1=True, use_r2=True, use_r3=True)
            self.logic_loss = LogicLoss(node_out_channels, use_r1=True, use_r2=True, use_r3=True)
        elif logic_rules == "r1":
            self.classifier = Classifier(node_out_channels, use_r1=True, use_r2=False, use_r3=False)
            self.logic_loss = LogicLoss(node_out_channels, use_r1=True, use_r2=False, use_r3=False)
        elif logic_rules == "r2":
            self.classifier = Classifier(node_out_channels, use_r1=False, use_r2=True, use_r3=False)
            self.logic_loss = LogicLoss(node_out_channels, use_r1=False, use_r2=True, use_r3=False)
        elif logic_rules == "r3":
            self.classifier = Classifier(node_out_channels, use_r1=False, use_r2=False, use_r3=True)
            self.logic_loss = LogicLoss(node_out_channels, use_r1=False, use_r2=False, use_r3=True)
        elif logic_rules == "r1_r3":
            self.classifier = Classifier(node_out_channels, use_r1=True, use_r2=False, use_r3=True)
            self.logic_loss = LogicLoss(node_out_channels, use_r1=True, use_r2=False, use_r3=True)
        elif logic_rules == "r2_r3":
            self.classifier = Classifier(node_out_channels, use_r1=False, use_r2=True, use_r3=True)
            self.logic_loss = LogicLoss(node_out_channels, use_r1=False, use_r2=True, use_r3=True)
        elif logic_rules == "r1_r2":
            self.classifier = Classifier(node_out_channels, use_r1=True, use_r2=True, use_r3=False)
            self.logic_loss = LogicLoss(node_out_channels, use_r1=True, use_r2=True, use_r3=False)
        elif logic_rules == "none":
            self.classifier = Classifier(node_out_channels, use_r1=False, use_r2=False, use_r3=False)
            self.logic_loss = LogicLoss(node_out_channels, use_r1=False, use_r2=False, use_r3=False)
        elif logic_rules == "all_c":
            self.classifier = Classifier(node_out_channels, use_r1=True, use_r2=True, use_r3=True)
            self.logic_loss = LogicLoss(node_out_channels, use_r1=False, use_r2=False, use_r3=False)
        elif logic_rules == "all_l":
            self.classifier = Classifier(node_out_channels, use_r1=False, use_r2=False, use_r3=False)
            self.logic_loss = LogicLoss(node_out_channels, use_r1=True, use_r2=True, use_r3=True)
